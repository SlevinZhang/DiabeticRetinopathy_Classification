...
class RESNET_DR(BASE_MODEL):
    
    """
    class RESNET_DR(model_name, kwargs)
    ...
    beta_1 : float
        beta_1 param specifically for Adam optimizer
        
    beta_2 : float
        beta_2 param specifically for Adam optimizer
    
    decay : float
        lr decay for adam optimizer
    ...
    def __init__(self, model_name='resnet50', **kwargs):
        super(RESNET_DR, self).__init__(model_name, (224, 224), **kwargs)
        ...
        if self.load_model is None:
            ...
            self.model = load_model(self.storage + 'models/model.h5')
